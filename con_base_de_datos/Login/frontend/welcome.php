...
<body>
    ...
    <h1>Bienvenid@ a nuestra página web (｡･∀･)ﾉﾞ</h1>
    ...
    <img id="mario_corriendo" title = "Es solo mario corriendo. No hace nada :P" src="../assets/imgs/mario_corriendo.gif" alt="mario_corriendo">
    </div>
</body>
